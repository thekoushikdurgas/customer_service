    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 15),
          Text(
            "ChatGPT is sensitive to tweaks to the input phrasing or attempting the same prompt multiple times. For durgas, given one phrasing of a question, the model can claim to not know the answer, but given a slight rephrase, can answer correctly.",
            style: TextStyle(fontSize: 16),
            textAlign: TextAlign.start,
          ),
          SizedBox(height: 15),
